...
<div class="container container-top">
    ...
    <div class="row top-margin">
        <div class="col-md-5 col-sm-7 no-padding">
            <img class="img-phone animation-element slide-left" src="/images/toopixel-phone-bread-dancer.jpg" title="TooPixel featured image"
                 alt="TooPixel Featured image"/>
        </div>
        <div class="col-md-7 no-padding">
            <h1 class="animation-element slide-right">Remarkable bread slices <div class="clearfix visible-md visible-lg"></div>right from the start</h1>
        </div>
        ...
        <div class="col-md-7 no-padding">
            <a href="#" title="Availabl on AppStore" class="animation-element fade-in">
